                ...
                <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                    <div class="col-12 mx-auto">
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                <form role="form text-left" action="{{ url('/pengajuan/input') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    class="form-control @error('jenis_bansos_id') is-invalid @enderror"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="surat_ket_tidak_mampu" type="file"
                                                    class="form-control @error('surat_ket_tidak_mampu') is-invalid @enderror"
                                                    aria-label="Name" value="{{ old('surat_ket_tidak_mampu') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="foto_kk" type="file"
                                                    ...
                                                    aria-label="Name" value="{{ old('foto_kk') }}">
                                                @error('foto_kk')
                                                    <span class="invalid-feedback" role="alert">
                                                        <div id="emailHelp" class="form-text text-danger">
                                                            {{ $message }}
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="foto_ktp" type="file"
                                                    ...
                                                    aria-label="Name" value="{{ old('foto_ktp') }}">
                                                @error('foto_ktp')
                                                    <span class="invalid-feedback" role="alert">
                                                        <div id="emailHelp" class="form-text text-danger">
                                                            {{ $message }}
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="foto_diri" type="file"
                                                    ...
                                                    aria-label="Name" value="{{ old('foto_diri') }}">
                                                @error('foto_diri')
                                                    <span class="invalid-feedback" role="alert">
                                                        <div id="emailHelp" class="form-text text-danger">
                                                            {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="foto_rmh_tampak_dpn" type="file"
                                                    class="form-control @error('foto_rmh_tampak_dpn') is-invalid @enderror"
                                                    aria-label="Name" value="{{ old('foto_rmh_tampak_dpn') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="foto_rmh_tampak_belakang" type="file"
                                                    class="form-control @error('foto_rmh_tampak_belakang') is-invalid @enderror"
                                                    aria-label="Name" value="{{ old('foto_rmh_tampak_belakang') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="luas_bangunan" type="number"
                                                    ...
                                                    aria-label="Name" placeholder="Masukkan luas bangunan."
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    name="status_rumah" id="">
                                                    <option value="">-- Pilih Status Rumah --
                                                    </option>
                                                    <option value="rumah_pribadi" @selected(old('status_rumah') == 'rumah_pribadi')>Rumah
                                                        Pribadi</option>
                                                    <option value="kontrakan" @selected(old('status_rumah') == 'kontrakan')>Rumah
                                                        Kontrakan</option>
                                                </select>
                                                @error('status_rumah')
                                                    <span class="invalid-feedback" role="alert">
